            ...
            <div className="grid grid-cols-4 gap-8">
                <div className="col-span-1">
                    <nav className="space-y-1">
                        <Link className="block rounded-lg bg-gray-200 px-3 py-2 text-sm font-semibold text-gray-900" href="#">
                            General
                        </Link>
                ...
                <div className="col-span-3 space-y-6">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">Click on the avatar to upload a custom one from your files.</p>
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">This is your URL namespace within Vercel.</p>
                        <div className="flex items-center">
                            <span className="mr-2 text-sm text-gray-600">vercel.com/</span>
                            <Input placeholder="john-doe" />
                        </div>
                        <div className="mt-4 flex justify-end">
                            <Button variant="outline">Cancel</Button>
